...
function Registerer(props) {
    if (props.isSignedIn === false)
        return (
            <React.Fragment>
                &nbsp;
                <Button color="btn btn-outline-light" outline onClick={props.toggleRegister}>
...
class Header extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Navbar color="primary" dark expand="xl" fixed="top">
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            ...
                            <Nav className="ml-auto" navbar>
                                <NavItem>
                                    {!this.props.auth.isAuthenticated ?
                                        <Button outline color="btn btn-light" onClick={this.toggleModal}>
                                        ...
                                        :
                                        <div>
                                            <div className="navbar-text mr-3">Welcome {this.props.auth.user.username}</div>
                                            <Button outline color="btn btn-light" onClick={this.handleLogout}>
                ...
                <Modal isOpen={!this.props.auth.isAuthenticated && this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <Button type="submit" value="submit" color="btn btn-primary">Login</Button>
                        </Form>
                    </ModalBody>
                </Modal>
